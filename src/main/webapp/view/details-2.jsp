...
<head>
    ...
    <title>Sân bóng Đại học Y Hà Nội</title>
    ...
    <div id="container-sanbong" class="container-fluid">
        <div class="row">
            <div class="col-sm-12 col-md-8 col-lg-8">
                <main>
                    <h4><b>Sân bóng Đại học Y Hà Nội</b></h4>
                    <img class="img-rounded img-thumbnail" src="../images/DHY/san-bong-dai-hoc-y_1629449262.jpg" alt="san-bong-dai-hoc-y">
                    <p><b>Giới thiệu chung:</b>Sân bóng Đại học Y Hà Nội nằm tại quận Đống Đa, gồm 4 sân đơn 7 người, đây là địa điểm cho nhiều cầu truyền hình trực tiếp tại hà nội như bóng đá, ca nhạc...</p>
                    <p><b>Địa chỉ:</b></p> <address>Trường Đại học Y Hà Nội, Khương Thượng, Đống Đa, Hà Nội</address>
                    <p><b>Các tiện ích tại sân:</b></p>
                    <ol type="1">
                        <li>Wifi miễn phí, khu dịch vụ căng tin</li>
                        <li>Nhà ăn, khu công trình phụ trợ</li>
                        <li>Có chỗ để xe máy, ô tô ngày đêm</li>
                        <li>An ninh đảm bảo, bảo vệ trực 24/7</li>
                        <li>có cho thuê quần áo thi đấu (310k/đội)</li>
                    ...
                    <ul>
                        ...
                        <li><time>17:30</time> - <time>20:30</time>: 650k/h</li>
                        <li><time>20:30</time> - <time>22:00</time>: 500k/h</li>
                    </ul>
                    <form method="get" action="${pageContext.request.contextPath }/FieldServlet">
                        <input type="hidden" value="2" name="tensan">
            ...
            <div class="hidden-sm col-md-4 col-lg-4">
                <aside>
                    ...
                    <figure>
                        <img class="img-rounded img-thumbnail" src="../images/DHY/san-bong-dai-hoc-y_1629449262.jpg" alt="san-bong-dai-hoc-y"><br>
                        <figcaption>Sân bóng tiêu chuân Châu Âu. Có dịch vụ đi căn tin, Có chỗ để xe máy, ô tô ngày đêm, Wifi miễn phí</figcaption>
                    </figure>
                    <figure>
                        <img class="img-rounded img-thumbnail" src="../images/DHY/san-bong-dai-hoc-y-3_1629449320.jpg" alt="san-bong-dai-hoc-y"><br>
                        <figcaption>Mặt cỏ nhân tạo được thay thường xuyên, đảm bảo tiêu chuẩn</figcaption>
                    </figure>
                    <figure>
                        <img class="img-rounded img-thumbnail" src="../images/DHY/san-bong-dai-hoc-y-5_1629449320.jpg" alt="san-bong-dai-hoc-y"><br>
                        <figcaption>Căn tin rộng rãi thoáng mát</figcaption>
                    </figure>
                    <figure>
                        <img class="img-rounded img-thumbnail" src="../images/DHY/san-bong-dai-hoc-y-4_1629449321.jpg" alt="san-bong-dai-hoc-y"><br>
    ...
    <footer id="container-footer" class="container-fluid">
        <div class="row">
            ...
            <div id="thongtin" class="col-sm-12 col-md-6 col-lg-6">
                ...
                <nav>
                    <ul>
                        <li><a href="/view/index.html">Trang chủ</a></li>
