	...
	<div id="confirm" class="container" style="width: 50vw">
		...
		<div class="row mt-4">
			<div class="col-sm-6 col-md-6">
				<h6>Tiền sân mỗi giờ</h6>
			</div>
			<div class="col-sm-6 col-md-6 text-end">
				<h6>${timeSlot.timeSlotFee} VNĐ</h6>
			</div>
		</div>
		<hr/>
		<div class="row mt-4">
			<div class="col-sm-6 col-md-6">
				<h6>Tiền trọng tài mỗi giờ</h6>
			</div>
			<div class="col-sm-6 col-md-6 text-end">
				<h6>${service.refereeFee } VNĐ</h6>
			</div>
		</div>
		<hr/>
		<div class="row mt-4">
			...
			<div class="col-sm-6 col-md-6 text-end">
				<h6>${customerOrder.times }</h6>
			</div>
		</div>
		<hr/>
		<div class="row mt-4">
			<div class="col-sm-6 col-md-6">
				<h6>Tiền đồng phục mỗi đội</h6>
			</div>
			<div class="col-sm-6 col-md-6 text-end">
				<h6>${service.uniformFee } VNĐ</h6>
			</div>
		</div>
		<hr/>
		<div class="row mt-4">
			...
			<div class="col-sm-6 col-md-6 text-end">
				<h6>${customerOrder.numberTeam }</h6>
			</div>
		</div>
		<hr/>
		<div class="row mt-4">
		...
		<div class="row">
			<div class="col-sm-6 col-md-6">
				<form method="post" action="${pageContext.request.contextPath }/ConfirmServlet">
					<input type="submit" class="btn btn-success" value="Xác nhận">
				</form>
			</div>
			<div class="col-sm-6 col-md-6 text-end">
				<form method="get" action="${pageContext.request.contextPath }/FieldServlet?tensan=${customerOrder.fieldId}">
					<input type="submit" class="btn btn-secondary" value="Quay lại">
				</form>
			</div>
		</div>
	</div>
